...
# Criando as colunas para layout
col1, col2 = st.columns([3, 1])  # Dividindo em 2 colunas (3 para gráfico e 1 para os controles)

# Coluna 1 (gráfico)
with col1:
    # Exibir o gráfico de heatmap
    st.subheader("Heatmap de Frequência de Verbos")
